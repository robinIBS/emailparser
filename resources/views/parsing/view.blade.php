        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <a href="#" class="btn btn-success"><i class="fa fa-cog" aria-hidden="true"></i> Add Parsing Rule</a>
                    <a href="#" class="btn btn-info"><i class="fa fa-envelope-o" aria-hidden="true"></i> Emails</a>
                    <a href="#" class="btn btn-primary"><i class="fa fa-download" aria-hidden="true"></i> File Download</a>
                    <a href="#" class="btn btn-primary"><i class="fa fa-share-alt" aria-hidden="true"></i> Integration</a>
                </div>
